    ...
    public override void Start()
    {
        _gameTree = new GameObject("GameTree")
            ...
            .SetTreesTextures(
                new()
                {
                    SvgConverter.LoadSvg( "Level1/Appletree1", new Vector2(512) * EGame.ResolutionCoefficient),
                    SvgConverter.LoadSvg( "Level1/Appletree2", new Vector2(512) * EGame.ResolutionCoefficient)
                },
                new()
                {
                    SvgConverter.LoadSvg( "Level1/Tree1", new Vector2(512) * EGame.ResolutionCoefficient),
                    SvgConverter.LoadSvg( "Level1/Tree2", new Vector2(512) * EGame.ResolutionCoefficient),
                    SvgConverter.LoadSvg( "Level1/Bushes", new Vector2(512) * EGame.ResolutionCoefficient),
                }
            )
            .SetButtons(
