...
internal class MainMenu : ILevel
{
    public Scene GetScene(ActualGame actualGame) =>
        new Scene(actualGame, "MainMenu")
            ...
            .Transform.SetPosition(new(actualGame.ViewportCenter.X, actualGame.ViewportSize.Y * 1.5f))
            ...
            .Transform.SetPosition(new(actualGame.ViewportCenter.X + 225 * actualGame.ResolutionCoefficient,
            ...
            .Transform.SetPosition(new(actualGame.ViewportCenter.X - 380 * actualGame.ResolutionCoefficient,
